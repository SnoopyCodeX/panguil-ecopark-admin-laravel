                                    ...
                                    <div class="auth-form-wrapper px-4 py-5">
                                        ...
                                        <form class="forms-sample" action="{{ route('login') }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="password" name="password" class="form-control" id="userPassword" value="{{ old('password') }}" autocomplete="current-password" placeholder="Password" required>
                                            </div>
                                            ...
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn-primary me-2 mb-2 text-white">Login</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
